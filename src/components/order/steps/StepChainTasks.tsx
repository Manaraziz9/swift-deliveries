  ...
  return (
    <div className="space-y-4 pb-20">
      ...
      <p className="text-sm text-muted-foreground">
        {lang === 'ar' 
          ? 'أضف المهام بالترتيب الذي تريد تنفيذها. سيقوم المنفذ بزيارة كل موقع بالتسلسل.'
          : 'Add tasks in the order you want them executed. The executor will visit each location in sequence.'}
      </p>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium truncate">
                  {lang === 'ar' ? `مهمة ${task.sequence}` : `Task ${task.sequence}`}
                </p>
